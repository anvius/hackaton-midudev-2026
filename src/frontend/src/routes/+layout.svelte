  ...
  <footer class="site-footer">
    ...
    <div class="footer-bottom">
      <div class="footer-bottom-text">
        <span>
          © {new Date().getFullYear()} DOCCUM — {$language === 'es' ? "software libre bajo" : "open-source under"} 
        ...
        <span class="made-with-love">Made with ❤️ in Mojácar by <a href="https://anvius.com" target="_blank" rel="noreferrer">@anvius</a></span>
      </div>
      ...
      <div class="footer-social">
          ...
          <!-- GitHub -->
          <a href="https://github.com/anvius/hackaton-midudev-2026" rel="noreferrer" target="_blank" title="GitHub">
          ...
          <!-- Codeberg -->
          <a href="https://codeberg.org/anvius" rel="noreferrer" target="_blank" title="Codeberg">
          ...
          <!-- Fosstodon -->
          <a href="https://fosstodon.org/@anvius" rel="me noreferrer" target="_blank" title="Fosstodon (Mastodon)">
